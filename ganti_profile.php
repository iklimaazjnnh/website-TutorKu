...
if(isset($_POST['simpan'])){
    ...
    if($nama_lengkap == ''){
        $err .= "<li>Silakan masukan nama lengkap</li>";
    }
    ...
    if($password !=''){ //jika akan melakukan perubahan password
        ...
        if(md5($password_lama) != $r1['password']){
            $err .= "<li>Password tidak sesuai dengan password sebelumnya.</li>";
        }

        if($password_lama == '' or $konfirmasi_password == '' or $password == ''){
            $err .= "<li>Silakan masukan password lama, password baru serta konfrimasi password.</li>";
        ...
        if(strlen($password) < 6){
            $err .= "<li>Panjang karakter yang diizinkan untuk password minimal 6 karakter.</li>";
        }
    }
