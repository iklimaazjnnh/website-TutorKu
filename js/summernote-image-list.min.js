    ...
    imageList: function (context) {
      ...
      this.createDialog = function (container) {
        var dialogOption = {
          ...
          footer: [
            '<button type="button" class="btn btn-default image-list-btn-close close">Close</button>',
          ].join(""),
          closeOnEscape: true,
        };
        ...
        return $.Deferred(function (deferred) {
          ui.onDialogShown(self.$dialog, function () {
            ...
            $.get(imageListOptions.endpoint, null, null, "json").done(function (
              ...
              self.$dialog.find(".image-list-item").click(function () {
                deferred.resolve({
            ...
            self.$dialog.find(".image-list-btn-closex").click(function () {
