...
<?php
function url_dasar(){
    // $_SERVER['SERVER_NAME'] : alamat website, contoh websiteku.com
    // $_SERVER['SCRIPT_NAME'] : direktory website, contoh websiteku.com/blog/$_SERVER['SCRIPT_NAME'] : blog
...
function buat_link_halaman($id){
    ...
    //http://localhost/website-tutorku/halaman.php/10/judul
