...
<!-- ketika halaman membuka get kata kunci dan ada isian dikata kunci tersebut maka nilainya akan dimasukan ke dalam variabel kata kunci jika tidak ada isinya maka diberi nilai 0 -->
        <?php
        $sukses = "";
    ...
    value="<?php echo $katakunci ?>" oninput="if(this.value===''){ window.location='halaman.php'; }">
